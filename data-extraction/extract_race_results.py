...
def main():
    ...
    os.makedirs("../data/raw/race_data", exist_ok=True)
    
    points_and_wins_until_2017 = pd.read_csv('../data/raw/driver_data/driver_points_and_wins.csv')
    ...
    for year in range(2018, 2024):
        ...
        race_results.to_csv(f"../data/raw/race_data/{year}_race_results.csv", index=False)
